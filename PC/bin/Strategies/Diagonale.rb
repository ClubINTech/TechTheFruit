...
class Diagonale < Strategie
        ...
        def sequence
			...
			@robot.goTo 800, 304, 3.14, :bypass
                        @robot.baisseFourche
                        @robot.selecteurMilieu
                        @robot.goTo 1155, 304, 3.14, :bypass
			@robot.avancer -20
			sleep 0.2
                        @robot.leveFourche
                        sleep 1
			@robot.changerVitesse(1500, 650)
                        @robot.goTo 300, 304
			@robot.changerVitesse(1500, 1500)
			@robot.goTo 200, 200
			#@robot.alignement Math::PI
			
			#pret a remonter la 2eme fois
			#@robot.goTo 800, 195, 3.14, :bypass
                        #@robot.baisseFourche
                        #@robot.selecteurMilieu
                        #@robot.goTo 1160, 190, 3.14, :bypass
			#@robot.avancer -40
			#sleep 0.2
                        #@robot.leveFourche
                        #sleep 1       
			...
			@robot.tourneDe(Math::PI)
                        ...
                        @robot.baisseFourche
                        @robot.selecteurMilieu
                        @robot.changerVitesse(1200, 1200)                
